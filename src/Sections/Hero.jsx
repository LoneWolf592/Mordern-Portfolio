            ...
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
                ...
                <div className='space-y-8'>
                    ...
                    <div className='flex items-center gap-4 animate-fade-in animation-delay-400'>
                        ...
                        {[
                            {icon: <FontAwesomeIcon icon={faGithub} />, href: "https://github.com/LoneWolf592"},
                            {icon: <FontAwesomeIcon icon={faLinkedin} />, href: "https://www.linkedin.com/in/kyshawn-henry/"},
                        ].map((social, idx) => (
                ...
                <div className='relative animate-fade-in animation-delay-300'>
                    ...
                    <div className='relative max-w-md mx-auto'>
                        ...
                        <div className='relative glass rounded-3xl p-2 glow-border'>
                            <img src={profilephoto} alt="Kyshawn Henry" className='w-full aspect-[4/5] object-cover rounded-2xl'/>

                            {/*Floating Badge */}
                            <div className='absolute -bottom-4 -right-4 glass rounded-3xl px-4 py-3 animate-float'>
