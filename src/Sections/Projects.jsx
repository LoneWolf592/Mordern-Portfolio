        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="text-center mx-auto max-w-2xl mb-16">
                ...
                <p className="text-muted-foreground animate-fade-in animation-delay-200">
                    A selection of projects that demonstrate my skills and passion for creating impactful solutions. Each project reflects my commitment to innovation, quality, and making a difference in the world through technology.
                </p>
            </div>
                ...
                {projects.map((project, idx) => (
                    ...
                    style={{animationDelay: `${(idx + 1) * 100 }ms`}}>
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex items-start jusify-between">
                                <h3 className="text-xl font-semibold group-hover:text-priamry transition-colors">{project.title}</h3>
                                <ArrowUpRight className="w-5 h-5
                                text-muted-foreground group-hover:text-primary
                                group-hover:translate-x-1
                                group-hover:-translate-y-1 transition-all"/>  
                            </div>
                            <p className="muted-foreground text-sm">{project.description}</p>
