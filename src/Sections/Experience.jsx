        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="max-w-3xl mb-16">
                ...
                animate-fade-in animation-delay-200">
                    A snapshot of my professional journey, showcasing the roles and experiences that have shaped my skills and passion for software development. Each position reflects my commitment to growth, learning, and making an impact in the tech industry.
                </p>
            </div>
